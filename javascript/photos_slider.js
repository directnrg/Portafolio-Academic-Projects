...
function populateFigures() {
   ...
   if (figureCount === 3) {
      for (var i = 1; i < 4; i++) {
         var filename = "./imgs/photo_slider/IMG_0" + photoOrder[i] + "sm.jpg";
         document.getElementsByTagName("img")[i - 1].src = filename;

      }
   } else {
      for (var i = 0; i < 5; i++) {
         var filename = "./imgs/photo_slider/IMG_0" + photoOrder[i] + "sm.jpg";
         document.getElementsByTagName("img")[i].src = filename;
      }
   }
}
...
function previewFive() {
   ...
   document.getElementsByTagName("img")[0].src = "./imgs/photo_slider/IMG_0" + photoOrder[0] + "sm.jpg";
   document.getElementsByTagName("img")[4].src = "./imgs/photo_slider/IMG_0" + photoOrder[4] + "sm.jpg";
}
...
function HidefavoriteBtn() {
   ...
   var favorite1 = document.getElementById("favorite1");
   var favorite2 = document.getElementById("favorite2");
   var favorite3 = document.getElementById("favorite3");
   var favorite4 = document.getElementById("favorite4");
   var favorite5 = document.getElementById("favorite5");
   ...
   favorite1.setAttribute("style", "display:none");
   favorite2.setAttribute("style", "display:none");
   favorite3.setAttribute("style", "display:none");
   favorite4.setAttribute("style", "display:none");
   favorite5.setAttribute("style", "display:none");
