...
function resetForm() {
    ...
    document.getElementById("ageImperial").value = 0;
    document.getElementById("ageMetric").value = 0;
    document.getElementById("genderImp").checked = false;
    document.getElementById("genderMet").checked = false;
